const OpenSeaNft = artifacts.require('OpenSeaNft');
...
module.exports = async (deployer, network, [defaultAccount]) => {
  ...
  if (network.startsWith('rinkeby')) {
    await deployer.deploy(OpenSeaNft, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH)
    let dnd = await OpenSeaNft.deployed()
